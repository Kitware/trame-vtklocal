...
function createWasm() {
 ...
 /** @param {WebAssembly.Module=} module*/ function receiveInstance(instance, module) {
  ...
  wasmMemory = wasmExports["li"];
  updateMemoryViews();
  wasmTable = wasmExports["pi"];
  addOnInit(wasmExports["mi"]);
...
var wasmImports = {
 ...
 /** @export */ gi: ___syscall_ioctl,
 /** @export */ fi: ___syscall_lstat64,
 /** @export */ ei: ___syscall_newfstatat,
 /** @export */ vb: ___syscall_openat,
 /** @export */ di: ___syscall_readlinkat,
 /** @export */ ci: ___syscall_stat64,
 /** @export */ zb: __embind_register_bigint,
 /** @export */ $h: __embind_register_bool,
 /** @export */ _h: __embind_register_emval,
 /** @export */ sb: __embind_register_float,
 /** @export */ x: __embind_register_function,
 /** @export */ u: __embind_register_integer,
 /** @export */ g: __embind_register_memory_view,
 /** @export */ rb: __embind_register_std_string,
 ...
 /** @export */ Dh: _eglQueryString,
 /** @export */ Ch: _eglSwapBuffers,
 /** @export */ Bh: _eglSwapInterval,
 /** @export */ Ah: _eglTerminate,
 /** @export */ zh: _eglWaitGL,
 /** @export */ yh: _eglWaitNative,
 /** @export */ xh: _emscripten_asm_const_int,
 /** @export */ l: _emscripten_asm_const_int_sync_on_main_thread,
 /** @export */ mb: _emscripten_cancel_main_loop,
 /** @export */ wh: _emscripten_clear_timeout,
 /** @export */ vh: _emscripten_date_now,
 /** @export */ uh: _emscripten_exit_fullscreen,
 /** @export */ th: _emscripten_exit_pointerlock,
 ...
 /** @export */ sh: _emscripten_get_heap_max,
 /** @export */ wa: _emscripten_get_now,
 /** @export */ rh: _emscripten_get_num_gamepads,
 /** @export */ qh: _emscripten_get_screen_size,
 /** @export */ ph: _emscripten_glActiveTexture,
 /** @export */ oh: _emscripten_glAttachShader,
 /** @export */ nh: _emscripten_glBeginQuery,
 /** @export */ mh: _emscripten_glBeginQueryEXT,
 /** @export */ lh: _emscripten_glBeginTransformFeedback,
 /** @export */ kh: _emscripten_glBindAttribLocation,
 /** @export */ jh: _emscripten_glBindBuffer,
 /** @export */ ih: _emscripten_glBindBufferBase,
 /** @export */ hh: _emscripten_glBindBufferRange,
 /** @export */ gh: _emscripten_glBindFramebuffer,
 /** @export */ fh: _emscripten_glBindRenderbuffer,
 /** @export */ eh: _emscripten_glBindSampler,
 /** @export */ dh: _emscripten_glBindTexture,
 /** @export */ ch: _emscripten_glBindTransformFeedback,
 /** @export */ bh: _emscripten_glBindVertexArray,
 /** @export */ ah: _emscripten_glBindVertexArrayOES,
 /** @export */ $g: _emscripten_glBlendColor,
 /** @export */ _g: _emscripten_glBlendEquation,
 /** @export */ Zg: _emscripten_glBlendEquationSeparate,
 /** @export */ Yg: _emscripten_glBlendFunc,
 /** @export */ Xg: _emscripten_glBlendFuncSeparate,
 /** @export */ Wg: _emscripten_glBlitFramebuffer,
 /** @export */ Vg: _emscripten_glBufferData,
 /** @export */ Ug: _emscripten_glBufferSubData,
 /** @export */ Tg: _emscripten_glCheckFramebufferStatus,
 /** @export */ Sg: _emscripten_glClear,
 /** @export */ Rg: _emscripten_glClearBufferfi,
 /** @export */ Qg: _emscripten_glClearBufferfv,
 /** @export */ Pg: _emscripten_glClearBufferiv,
 /** @export */ Og: _emscripten_glClearBufferuiv,
 /** @export */ Ng: _emscripten_glClearColor,
 /** @export */ Mg: _emscripten_glClearDepthf,
 /** @export */ Lg: _emscripten_glClearStencil,
 /** @export */ Kg: _emscripten_glClientWaitSync,
 /** @export */ Jg: _emscripten_glColorMask,
 /** @export */ Ig: _emscripten_glCompileShader,
 /** @export */ Hg: _emscripten_glCompressedTexImage2D,
 /** @export */ Gg: _emscripten_glCompressedTexImage3D,
 /** @export */ Fg: _emscripten_glCompressedTexSubImage2D,
 /** @export */ Eg: _emscripten_glCompressedTexSubImage3D,
 /** @export */ Dg: _emscripten_glCopyBufferSubData,
 /** @export */ Cg: _emscripten_glCopyTexImage2D,
 /** @export */ Bg: _emscripten_glCopyTexSubImage2D,
 /** @export */ Ag: _emscripten_glCopyTexSubImage3D,
 /** @export */ zg: _emscripten_glCreateProgram,
 /** @export */ yg: _emscripten_glCreateShader,
 /** @export */ xg: _emscripten_glCullFace,
 /** @export */ wg: _emscripten_glDeleteBuffers,
 /** @export */ vg: _emscripten_glDeleteFramebuffers,
 /** @export */ ug: _emscripten_glDeleteProgram,
 /** @export */ tg: _emscripten_glDeleteQueries,
 /** @export */ sg: _emscripten_glDeleteQueriesEXT,
 /** @export */ rg: _emscripten_glDeleteRenderbuffers,
 /** @export */ qg: _emscripten_glDeleteSamplers,
 /** @export */ pg: _emscripten_glDeleteShader,
 /** @export */ og: _emscripten_glDeleteSync,
 /** @export */ ng: _emscripten_glDeleteTextures,
 /** @export */ mg: _emscripten_glDeleteTransformFeedbacks,
 /** @export */ lg: _emscripten_glDeleteVertexArrays,
 /** @export */ kg: _emscripten_glDeleteVertexArraysOES,
 /** @export */ jg: _emscripten_glDepthFunc,
 /** @export */ ig: _emscripten_glDepthMask,
 /** @export */ hg: _emscripten_glDepthRangef,
 /** @export */ gg: _emscripten_glDetachShader,
 /** @export */ fg: _emscripten_glDisable,
 /** @export */ eg: _emscripten_glDisableVertexAttribArray,
 /** @export */ dg: _emscripten_glDrawArrays,
 /** @export */ cg: _emscripten_glDrawArraysInstanced,
 /** @export */ bg: _emscripten_glDrawArraysInstancedANGLE,
 /** @export */ ag: _emscripten_glDrawArraysInstancedARB,
 /** @export */ $f: _emscripten_glDrawArraysInstancedEXT,
 /** @export */ _f: _emscripten_glDrawArraysInstancedNV,
 /** @export */ Zf: _emscripten_glDrawBuffers,
 /** @export */ Yf: _emscripten_glDrawBuffersEXT,
 /** @export */ Xf: _emscripten_glDrawBuffersWEBGL,
 /** @export */ Wf: _emscripten_glDrawElements,
 /** @export */ Vf: _emscripten_glDrawElementsInstanced,
 /** @export */ Uf: _emscripten_glDrawElementsInstancedANGLE,
 /** @export */ Tf: _emscripten_glDrawElementsInstancedARB,
 /** @export */ Sf: _emscripten_glDrawElementsInstancedEXT,
 /** @export */ Rf: _emscripten_glDrawElementsInstancedNV,
 /** @export */ Qf: _emscripten_glDrawRangeElements,
 /** @export */ Pf: _emscripten_glEnable,
 /** @export */ Of: _emscripten_glEnableVertexAttribArray,
 /** @export */ Nf: _emscripten_glEndQuery,
 /** @export */ Mf: _emscripten_glEndQueryEXT,
 /** @export */ Lf: _emscripten_glEndTransformFeedback,
 /** @export */ Kf: _emscripten_glFenceSync,
 /** @export */ Jf: _emscripten_glFinish,
 /** @export */ If: _emscripten_glFlush,
 /** @export */ Hf: _emscripten_glFlushMappedBufferRange,
 /** @export */ Gf: _emscripten_glFramebufferRenderbuffer,
 /** @export */ Ff: _emscripten_glFramebufferTexture2D,
 /** @export */ Ef: _emscripten_glFramebufferTextureLayer,
 /** @export */ Df: _emscripten_glFrontFace,
 /** @export */ Cf: _emscripten_glGenBuffers,
 /** @export */ Bf: _emscripten_glGenFramebuffers,
 /** @export */ Af: _emscripten_glGenQueries,
 /** @export */ zf: _emscripten_glGenQueriesEXT,
 /** @export */ yf: _emscripten_glGenRenderbuffers,
 /** @export */ xf: _emscripten_glGenSamplers,
 /** @export */ wf: _emscripten_glGenTextures,
 /** @export */ vf: _emscripten_glGenTransformFeedbacks,
 /** @export */ uf: _emscripten_glGenVertexArrays,
 /** @export */ tf: _emscripten_glGenVertexArraysOES,
 /** @export */ sf: _emscripten_glGenerateMipmap,
 /** @export */ rf: _emscripten_glGetActiveAttrib,
 /** @export */ qf: _emscripten_glGetActiveUniform,
 /** @export */ pf: _emscripten_glGetActiveUniformBlockName,
 /** @export */ of: _emscripten_glGetActiveUniformBlockiv,
 /** @export */ nf: _emscripten_glGetActiveUniformsiv,
 /** @export */ mf: _emscripten_glGetAttachedShaders,
 /** @export */ lf: _emscripten_glGetAttribLocation,
 /** @export */ kf: _emscripten_glGetBooleanv,
 /** @export */ jf: _emscripten_glGetBufferParameteri64v,
 /** @export */ hf: _emscripten_glGetBufferParameteriv,
 /** @export */ gf: _emscripten_glGetBufferPointerv,
 /** @export */ ff: _emscripten_glGetError,
 /** @export */ ef: _emscripten_glGetFloatv,
 /** @export */ df: _emscripten_glGetFragDataLocation,
 /** @export */ cf: _emscripten_glGetFramebufferAttachmentParameteriv,
 /** @export */ bf: _emscripten_glGetInteger64i_v,
 /** @export */ af: _emscripten_glGetInteger64v,
 /** @export */ $e: _emscripten_glGetIntegeri_v,
 /** @export */ _e: _emscripten_glGetIntegerv,
 /** @export */ Ze: _emscripten_glGetInternalformativ,
 /** @export */ Ye: _emscripten_glGetProgramBinary,
 /** @export */ Xe: _emscripten_glGetProgramInfoLog,
 /** @export */ We: _emscripten_glGetProgramiv,
 /** @export */ Ve: _emscripten_glGetQueryObjecti64vEXT,
 /** @export */ Ue: _emscripten_glGetQueryObjectivEXT,
 /** @export */ Te: _emscripten_glGetQueryObjectui64vEXT,
 /** @export */ Se: _emscripten_glGetQueryObjectuiv,
 /** @export */ Re: _emscripten_glGetQueryObjectuivEXT,
 /** @export */ Qe: _emscripten_glGetQueryiv,
 /** @export */ Pe: _emscripten_glGetQueryivEXT,
 /** @export */ Oe: _emscripten_glGetRenderbufferParameteriv,
 /** @export */ Ne: _emscripten_glGetSamplerParameterfv,
 /** @export */ Me: _emscripten_glGetSamplerParameteriv,
 /** @export */ Le: _emscripten_glGetShaderInfoLog,
 /** @export */ Ke: _emscripten_glGetShaderPrecisionFormat,
 /** @export */ Je: _emscripten_glGetShaderSource,
 /** @export */ Ie: _emscripten_glGetShaderiv,
 /** @export */ He: _emscripten_glGetString,
 /** @export */ Ge: _emscripten_glGetStringi,
 /** @export */ Fe: _emscripten_glGetSynciv,
 /** @export */ Ee: _emscripten_glGetTexParameterfv,
 /** @export */ De: _emscripten_glGetTexParameteriv,
 /** @export */ Ce: _emscripten_glGetTransformFeedbackVarying,
 /** @export */ Be: _emscripten_glGetUniformBlockIndex,
 /** @export */ Ae: _emscripten_glGetUniformIndices,
 /** @export */ ze: _emscripten_glGetUniformLocation,
 /** @export */ ye: _emscripten_glGetUniformfv,
 /** @export */ xe: _emscripten_glGetUniformiv,
 /** @export */ we: _emscripten_glGetUniformuiv,
 /** @export */ ve: _emscripten_glGetVertexAttribIiv,
 /** @export */ ue: _emscripten_glGetVertexAttribIuiv,
 /** @export */ te: _emscripten_glGetVertexAttribPointerv,
 /** @export */ se: _emscripten_glGetVertexAttribfv,
 /** @export */ re: _emscripten_glGetVertexAttribiv,
 /** @export */ qe: _emscripten_glHint,
 /** @export */ pe: _emscripten_glInvalidateFramebuffer,
 /** @export */ oe: _emscripten_glInvalidateSubFramebuffer,
 /** @export */ ne: _emscripten_glIsBuffer,
 /** @export */ me: _emscripten_glIsEnabled,
 /** @export */ le: _emscripten_glIsFramebuffer,
 /** @export */ ke: _emscripten_glIsProgram,
 /** @export */ je: _emscripten_glIsQuery,
 /** @export */ ie: _emscripten_glIsQueryEXT,
 /** @export */ he: _emscripten_glIsRenderbuffer,
 /** @export */ ge: _emscripten_glIsSampler,
 /** @export */ fe: _emscripten_glIsShader,
 /** @export */ ee: _emscripten_glIsSync,
 /** @export */ de: _emscripten_glIsTexture,
 /** @export */ ce: _emscripten_glIsTransformFeedback,
 /** @export */ be: _emscripten_glIsVertexArray,
 /** @export */ ae: _emscripten_glIsVertexArrayOES,
 /** @export */ $d: _emscripten_glLineWidth,
 /** @export */ _d: _emscripten_glLinkProgram,
 /** @export */ Zd: _emscripten_glMapBufferRange,
 /** @export */ Yd: _emscripten_glPauseTransformFeedback,
 /** @export */ Xd: _emscripten_glPixelStorei,
 /** @export */ Wd: _emscripten_glPolygonOffset,
 /** @export */ Vd: _emscripten_glProgramBinary,
 /** @export */ Ud: _emscripten_glProgramParameteri,
 /** @export */ Td: _emscripten_glQueryCounterEXT,
 /** @export */ Sd: _emscripten_glReadBuffer,
 /** @export */ Rd: _emscripten_glReadPixels,
 /** @export */ Qd: _emscripten_glReleaseShaderCompiler,
 /** @export */ Pd: _emscripten_glRenderbufferStorage,
 /** @export */ Od: _emscripten_glRenderbufferStorageMultisample,
 /** @export */ Nd: _emscripten_glResumeTransformFeedback,
 /** @export */ Md: _emscripten_glSampleCoverage,
 /** @export */ Ld: _emscripten_glSamplerParameterf,
 /** @export */ Kd: _emscripten_glSamplerParameterfv,
 /** @export */ Jd: _emscripten_glSamplerParameteri,
 /** @export */ Id: _emscripten_glSamplerParameteriv,
 /** @export */ Hd: _emscripten_glScissor,
 /** @export */ Gd: _emscripten_glShaderBinary,
 /** @export */ Fd: _emscripten_glShaderSource,
 /** @export */ Ed: _emscripten_glStencilFunc,
 /** @export */ Dd: _emscripten_glStencilFuncSeparate,
 /** @export */ Cd: _emscripten_glStencilMask,
 /** @export */ Bd: _emscripten_glStencilMaskSeparate,
 /** @export */ Ad: _emscripten_glStencilOp,
 /** @export */ zd: _emscripten_glStencilOpSeparate,
 /** @export */ yd: _emscripten_glTexImage2D,
 /** @export */ xd: _emscripten_glTexImage3D,
 /** @export */ wd: _emscripten_glTexParameterf,
 /** @export */ vd: _emscripten_glTexParameterfv,
 /** @export */ ud: _emscripten_glTexParameteri,
 /** @export */ td: _emscripten_glTexParameteriv,
 /** @export */ sd: _emscripten_glTexStorage2D,
 /** @export */ rd: _emscripten_glTexStorage3D,
 /** @export */ qd: _emscripten_glTexSubImage2D,
 /** @export */ pd: _emscripten_glTexSubImage3D,
 /** @export */ od: _emscripten_glTransformFeedbackVaryings,
 /** @export */ nd: _emscripten_glUniform1f,
 /** @export */ md: _emscripten_glUniform1fv,
 /** @export */ ld: _emscripten_glUniform1i,
 /** @export */ kd: _emscripten_glUniform1iv,
 /** @export */ jd: _emscripten_glUniform1ui,
 /** @export */ id: _emscripten_glUniform1uiv,
 /** @export */ hd: _emscripten_glUniform2f,
 /** @export */ gd: _emscripten_glUniform2fv,
 /** @export */ fd: _emscripten_glUniform2i,
 /** @export */ ed: _emscripten_glUniform2iv,
 /** @export */ dd: _emscripten_glUniform2ui,
 /** @export */ cd: _emscripten_glUniform2uiv,
 /** @export */ bd: _emscripten_glUniform3f,
 /** @export */ ad: _emscripten_glUniform3fv,
 /** @export */ $c: _emscripten_glUniform3i,
 /** @export */ _c: _emscripten_glUniform3iv,
 /** @export */ Zc: _emscripten_glUniform3ui,
 /** @export */ Yc: _emscripten_glUniform3uiv,
 /** @export */ Xc: _emscripten_glUniform4f,
 /** @export */ Wc: _emscripten_glUniform4fv,
 /** @export */ Vc: _emscripten_glUniform4i,
 /** @export */ Uc: _emscripten_glUniform4iv,
 /** @export */ Tc: _emscripten_glUniform4ui,
 /** @export */ Sc: _emscripten_glUniform4uiv,
 /** @export */ Rc: _emscripten_glUniformBlockBinding,
 /** @export */ Qc: _emscripten_glUniformMatrix2fv,
 /** @export */ Pc: _emscripten_glUniformMatrix2x3fv,
 /** @export */ Oc: _emscripten_glUniformMatrix2x4fv,
 /** @export */ Nc: _emscripten_glUniformMatrix3fv,
 /** @export */ Mc: _emscripten_glUniformMatrix3x2fv,
 /** @export */ Lc: _emscripten_glUniformMatrix3x4fv,
 /** @export */ Kc: _emscripten_glUniformMatrix4fv,
 /** @export */ Jc: _emscripten_glUniformMatrix4x2fv,
 /** @export */ Ic: _emscripten_glUniformMatrix4x3fv,
 /** @export */ Hc: _emscripten_glUnmapBuffer,
 /** @export */ Gc: _emscripten_glUseProgram,
 /** @export */ Fc: _emscripten_glValidateProgram,
 /** @export */ Ec: _emscripten_glVertexAttrib1f,
 /** @export */ Dc: _emscripten_glVertexAttrib1fv,
 /** @export */ Cc: _emscripten_glVertexAttrib2f,
 /** @export */ Bc: _emscripten_glVertexAttrib2fv,
 /** @export */ Ac: _emscripten_glVertexAttrib3f,
 /** @export */ zc: _emscripten_glVertexAttrib3fv,
 /** @export */ yc: _emscripten_glVertexAttrib4f,
 /** @export */ xc: _emscripten_glVertexAttrib4fv,
 /** @export */ wc: _emscripten_glVertexAttribDivisor,
 /** @export */ vc: _emscripten_glVertexAttribDivisorANGLE,
 /** @export */ uc: _emscripten_glVertexAttribDivisorARB,
 /** @export */ tc: _emscripten_glVertexAttribDivisorEXT,
 /** @export */ sc: _emscripten_glVertexAttribDivisorNV,
 /** @export */ rc: _emscripten_glVertexAttribI4i,
 /** @export */ qc: _emscripten_glVertexAttribI4iv,
 /** @export */ pc: _emscripten_glVertexAttribI4ui,
 /** @export */ oc: _emscripten_glVertexAttribI4uiv,
 /** @export */ nc: _emscripten_glVertexAttribIPointer,
 /** @export */ mc: _emscripten_glVertexAttribPointer,
 /** @export */ lc: _emscripten_glViewport,
 /** @export */ kc: _emscripten_glWaitSync,
 /** @export */ va: _emscripten_has_asyncify,
 /** @export */ jc: _emscripten_request_fullscreen_strategy,
 /** @export */ kb: _emscripten_request_pointerlock,
 /** @export */ ic: _emscripten_resize_heap,
 ...
 /** @export */ hc: _emscripten_set_main_loop_arg,
 ...
 /** @export */ gc: _emscripten_set_window_title,
 ...
 /** @export */ cc: _glClearStencil,
 /** @export */ W: _glColorMask,
 /** @export */ bc: _glCompileShader,
 /** @export */ ac: _glCopyBufferSubData,
 /** @export */ La: _glCopyTexImage2D,
 /** @export */ $b: _glCreateProgram,
 /** @export */ _b: _glCreateShader,
 /** @export */ ma: _glCullFace,
 /** @export */ G: _glDeleteBuffers,
 /** @export */ Zb: _glDeleteFramebuffers,
 /** @export */ Yb: _glDeleteProgram,
 /** @export */ Xb: _glDeleteQueries,
 /** @export */ la: _glDeleteRenderbuffers,
 /** @export */ ka: _glDeleteShader,
 /** @export */ Wb: _glDeleteTextures,
 ...
 /** @export */ Vb: _glDrawElements,
 /** @export */ Ub: _glDrawElementsInstanced,
 ...
 /** @export */ Sb: _glGenFramebuffers,
 /** @export */ Rb: _glGenRenderbuffers,
 /** @export */ Qb: _glGenTextures,
 /** @export */ Pb: _glGenVertexArrays,
 ...
 /** @export */ wb: _strftime_l
};

var wasmExports = createWasm();

var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports["mi"])();

var _malloc = a0 => (_malloc = wasmExports["ni"])(a0);

var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["oi"])(a0, a1);

var _free = a0 => (_free = wasmExports["qi"])(a0);

var ___getTypeName = a0 => (___getTypeName = wasmExports["ri"])(a0);

var _emscripten_builtin_memalign = (a0, a1) => (_emscripten_builtin_memalign = wasmExports["si"])(a0, a1);
...
var ___cxa_is_pointer_type = a0 => (___cxa_is_pointer_type = wasmExports["xi"])(a0);

var dynCall_viij = Module["dynCall_viij"] = (a0, a1, a2, a3, a4) => (dynCall_viij = Module["dynCall_viij"] = wasmExports["yi"])(a0, a1, a2, a3, a4);

var dynCall_vij = Module["dynCall_vij"] = (a0, a1, a2, a3) => (dynCall_vij = Module["dynCall_vij"] = wasmExports["zi"])(a0, a1, a2, a3);

var dynCall_iij = Module["dynCall_iij"] = (a0, a1, a2, a3) => (dynCall_iij = Module["dynCall_iij"] = wasmExports["Ai"])(a0, a1, a2, a3);

var dynCall_viji = Module["dynCall_viji"] = (a0, a1, a2, a3, a4) => (dynCall_viji = Module["dynCall_viji"] = wasmExports["Bi"])(a0, a1, a2, a3, a4);

var dynCall_jiji = Module["dynCall_jiji"] = (a0, a1, a2, a3, a4) => (dynCall_jiji = Module["dynCall_jiji"] = wasmExports["Ci"])(a0, a1, a2, a3, a4);

var dynCall_ji = Module["dynCall_ji"] = (a0, a1) => (dynCall_ji = Module["dynCall_ji"] = wasmExports["Di"])(a0, a1);

var dynCall_viijii = Module["dynCall_viijii"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_viijii = Module["dynCall_viijii"] = wasmExports["Ei"])(a0, a1, a2, a3, a4, a5, a6);

var dynCall_iiiiij = Module["dynCall_iiiiij"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iiiiij = Module["dynCall_iiiiij"] = wasmExports["Fi"])(a0, a1, a2, a3, a4, a5, a6);

var dynCall_iiiiijj = Module["dynCall_iiiiijj"] = (a0, a1, a2, a3, a4, a5, a6, a7, a8) => (dynCall_iiiiijj = Module["dynCall_iiiiijj"] = wasmExports["Gi"])(a0, a1, a2, a3, a4, a5, a6, a7, a8);

var dynCall_iiiiiijj = Module["dynCall_iiiiiijj"] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9) => (dynCall_iiiiiijj = Module["dynCall_iiiiiijj"] = wasmExports["Hi"])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9);
...
export default vtkWASMObjectManager;globalThis.vtkWASMObjectManager = vtkWASMObjectManager;
